...
const PhotosPage = () => {
  ...
  const photos: Photo[] = [
    ...
    },
    {
      ...
      year: '4',
      term: '4B',
      description: 'Adding banner on 7th floor stairs for Prank!',
      category: 'social',
    },
        {
      id: '14',
      src: '/gallery/snowday.png',
      alt: 'Snow Day',
      year: '2',
      term: '2A',
      description: 'Snow igloo during a fun snow day!',
      category: 'social',
    },
    {
      id: '15',
      src: '/gallery/2b_class.jpeg',
      alt: 'Class Memory',
      year: '2',
      term: '2B',
      description: 'Lecture',
      category: 'social',
        ...
        {
      id: '16',
      src: '/gallery/2b-pic.jpg',
      alt: 'Class Memory',
      year: '2',
      term: '2B',
      description: 'End of term photo with Prof Wright',
      category: 'social',
    },
    {
      id: '16',
      src: '/gallery/waterballoons.jpg',
      alt: 'Class Memory',
      year: '2',
      term: '2B',
      description: 'Waterballons for end of summer fight',
      category: 'social',
    },
    {
      id: '17',
      src: '/gallery/fluids-lab.jpg',
      alt: 'Fluids Lab',
      year: '3',
      term: '3B',
      description: 'Fluids lab experiment setup to measure properties of fluids and relationships',
      category: 'academic',
    },
  ];
